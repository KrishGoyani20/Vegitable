...
const SignInForgetPassOTP = ({ navigation }) => {
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.OPTImage}>
                <Image style={styles.Himage} source={Images.FPOTP} />
            </View>
            ...
            <View style={styles.footer}>
                ...
                <TouchableOpacity style={styles.confirmbtn} onPress={() => navigation.navigate('SignInNewPassScreen')}>
...
export default SignInForgetPassOTP
